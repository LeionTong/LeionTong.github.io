...
<div class="da-cards">
  ...
  <a class="da-card" href="/daily-terminal/2026-09-17-1037.html">
    ...
    <div class="da-card-title">LEION · DAILY TERMINAL</div>
    <div class="da-card-main">第 21 期 · 2026-09-17 · 语音终端 / 穿戴 / 桌面机器人：Voice PE 固件、小智生态与 Bangle.js 应用生态</div>
    <div class="da-card-go">阅读完整报告 →</div>
  </a>
  ...
  <a class="da-card" href="/daily-terminal/2026-09-14-1041.html">
    ...
    <div class="da-card-main">本期扫描智能屏显示、具身、服务端配套三扇区，经活跃度与许可证闸门筛选 8 个开源终端硬件项目：智能镜、e-paper 驱动、宇树遥操作、数字人平台、机器人 sim-to-real、开源人形整机、ESP32 屏驱与网球规划复现。</div>
    <div class="da-card-go">阅读完整报告 →</div>
  </a>
  ...
  <a class="da-card" href="/daily-terminal/2026-09-09-1042.html">
    ...
    <div class="da-card-main">本期扫描语音终端 · 穿戴 · 桌面机器人三个扇区，五条查询命中候选，经活跃度与质量闸门后入选 7 个项目。可玩性普遍不低，但商业化强度呈清晰的两极分化。</div>
    <div class="da-card-go">阅读完整报告 →</div>
  </a>
</div>
